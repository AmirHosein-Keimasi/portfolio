  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col md:flex-row relative px-4 md:px-8 py-8 md:py-12">
        ...
        <div className="absolute bottom-0 right-0 md:absolute md:bottom-0 md:right-0 flex items-end justify-end md:w-1/3 lg:w-2/5 pointer-events-none">
          <Image
            src="/assets/1.png"
            alt="Profile"
            width={400}
            height={400}
            className="w-[180px] h-[180px] md:w-[300px] md:h-[300px] lg:w-[400px] lg:h-[400px] rounded-full object-cover"
            priority
            placeholder="blur"
